...
/**
 * Created by William Goelz, Charlotte Somerville, and Bridger Mattson for G3 Robotics (Blue).
...
@Autonomous ( name = "EncoderAutonRedLeft")

//Right motor is reversed, negative direction goes left and positive goes right

public class EncoderAutonRedLeft extends LinearOpMode {
    @Override
